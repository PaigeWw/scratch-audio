...
var minilog = __webpack_require__(24);
minilog.enable();
...
var AudioEngine = function () {
    ...
    _createClass(AudioEngine, [{
        ...
        value: function decodeSound(sound) {
            ...
            var bufferCopy = sound.data.buffer;

            switch (sound.format) {
                case '':
                    loaderPromise = new Promise(function (resolve, reject){
                        Tone.context.decodeAudioData(sound.data.buffer,function(data){
                            resolve(data);
                        },function(){
...
var midi = __webpack_require__(30)
...
var midimessage = __webpack_require__(17)
